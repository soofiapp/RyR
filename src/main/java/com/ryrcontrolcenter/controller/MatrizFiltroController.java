...
public class MatrizFiltroController implements Initializable {
    ...
    @FXML
    private TableView<?> tablaMatriz;
    @FXML
    private TableColumn<?, ?> colSistema;
    @FXML
    private TableColumn<?, ?> colCodigoOem;
    @FXML
    private TableColumn<?, ?> colRefStock;
    @FXML
    ...
    private void onAgregarFiltroClick(ActionEvent event) {
        ...
        try {
            Stage stage = new Stage();
            Parent root = FXMLLoader.load(getClass().getResource("/com/ryrcontrolcenter/ui/NuevoFiltroVista.fxml"));
            stage.setScene(new Scene(root));
